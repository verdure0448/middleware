...
public class WebsocketApiAdapter extends AbstractAdapter{
	...
	public WebsocketApiAdapter(BundleContext ctx){
		super(ctx);
		this.ctx = ctx;
	}
	...
	public IAdapterFactory getFactory(ICommonService service) {
		return new WebsocketApiAdapterFactory(service, pm, am, em);
	}
