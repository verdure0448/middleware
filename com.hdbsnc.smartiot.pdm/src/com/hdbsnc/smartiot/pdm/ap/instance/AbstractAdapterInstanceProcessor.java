...
public abstract class AbstractAdapterInstanceProcessor implements IAdapterProcessor, IContextCallback{
	...
	public AbstractAdapterInstanceProcessor(ICommonService service, IAdapterContext ctx){
