	...
	module.controller("exampleCtrl", function($scope, $http) {
		...
		var columnDefs = [
        {headerName: "Athletes", field: "athlete", width: 150, cellRenderer: athleteCellRendererFunc},
		...
		$http.get("http://www.ag-grid.com/angular-grid-filtering/olympicWinners.json")
        .then(function(res){
