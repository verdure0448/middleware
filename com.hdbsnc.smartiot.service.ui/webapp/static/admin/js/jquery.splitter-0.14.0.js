...
(function($, undefined) {
    ...
    $.fn.split = function(options) {
        ...
        if (settings.orientation == 'vertical') {
            ...
            cls = 'hsplitter';
        }else if (settings.orientation == 'horizontal1') {
            panel_1 = children.first().addClass('top_panel')
            panel_2 = panel_1.next().addClass('bottom_panel');
            cls = 'hsplitter';
        }
        ...
        self.bind('splitter.resize', function(e) {
            ...
            }else if (self.orientation == 'horizontal1' &&
                       pos > self.height()) {
                pos = self.height() - self.limit-1;
            }
            if (pos < self.limit) {
                ...
                if (current_splitter !== null) {
                    ...
                    if (current_splitter.orientation == 'vertical') {
                        ...
                        if (y > current_splitter.limit &&
                            ...
                            $(".topGridContents").height(323-setHeight);
                            $(".downGridContents").height(323+setHeight);         
                            
                            e.preventDefault();
                        }
                    }else if (current_splitter.orientation == 'horizontal1') {
                        var y = e.pageY-offset.top;
                        if (y <= current_splitter.limit) {
                            y = current_splitter.limit + 1;
                        } else if (y >= current_splitter.height() - limit) {
                        ...
                        if (y > current_splitter.limit &&
                            ...
                            $(".topGridContents1").height(323-setHeight);
                            $(".downGridContents1").height(323+setHeight);         
