...
bsnc.otp.api.ins = function(authObj) {
	...
	return {
		...
		plcStart : function(iid, cbSucessFunc, cbFailFunc) {
			var otpStruct = bsnc.otp.util.struct();
			otpStruct.setPath("plc/ins/start");
			otpStruct.setParam("instance.id", iid);
			otpStruct.setSID(_authObj.getAuthInfo().sid);
			otpStruct.setTID(_authObj.getAuthInfo().tid);
		...
		plcStop : function(iid, cbSucessFunc, cbFailFunc) {
			var otpStruct = bsnc.otp.util.struct();
			otpStruct.setPath("plc/ins/stop");
			otpStruct.setParam("instance.id", iid);
			otpStruct.setSID(_authObj.getAuthInfo().sid);
			otpStruct.setTID(_authObj.getAuthInfo().tid);
...
bsnc.otp.api.ins.att = function(authObj) {
	...
	return {
		...
		/** 2016/04/01 ADD 명화공업용 START */
		plcPut : function(iid, attKey, content, contentType, cbSucessFunc,
				cbFailFunc) {
			var otpStruct = bsnc.otp.util.struct();
			otpStruct.setPath("plc/ins/att/put");
			otpStruct.setParam("instance.id", iid);
			otpStruct.setParam("attribution.key", attKey);
			otpStruct.setSID(_authObj.getAuthInfo().sid);
			otpStruct.setTID(_authObj.getAuthInfo().tid);
		...
		/** 2016/04/01 ADD 명화공업용 START */
		plcDel : function(iid, attKey, cbSucessFunc, cbFailFunc) {
			var otpStruct = bsnc.otp.util.struct();
			otpStruct.setPath("plc/ins/att/del");
			otpStruct.setParam("instance.id", iid);
			otpStruct.setParam("attribution.key", attKey);
			otpStruct.setSID(_authObj.getAuthInfo().sid);
			otpStruct.setTID(_authObj.getAuthInfo().tid);
		...
		plcSearchByIid : function(iid, cbSucessFunc, cbFailFunc) {
			var otpStruct = bsnc.otp.util.struct();
			otpStruct.setPath("plc/ins/att/search/by-iid");
			otpStruct.setParam("instance.id", iid);
			otpStruct.setSID(_authObj.getAuthInfo().sid);
			otpStruct.setTID(_authObj.getAuthInfo().tid);
...
bsnc.otp.api.adt = function(authObj) {
	...
	return {
		...
		/** 2016/04/01 ADD 명화공업용 START */
		plcGetAll : function(cbSucessFunc, cbFailFunc) {
			var otpStruct = bsnc.otp.util.struct();
			otpStruct.setPath("plc/adt/get/all");
			otpStruct.setSID(_authObj.getAuthInfo().sid);
			otpStruct.setTID(_authObj.getAuthInfo().tid);
...
bsnc.otp.api.event = function(authObj) {
	...
	return {
		...
		/** 2016/04/01 ADD 명화공업용 START */
		plcGatheringStart : function(did, content, contentType,cbSucessFunc, cbFailFunc, cbEventFunc) {
			var otpStruct = bsnc.otp.util.struct();
			otpStruct.setPath("plc/gathering/start");
			otpStruct.setParam("device.id", did);
			otpStruct.setParam("event.id", did);
			otpStruct.setSID(_authObj.getAuthInfo().sid);
			otpStruct.setTID(_authObj.getAuthInfo().tid);
		...
		plcGatheringStop : function(did, attKey, cbSucessFunc, cbFailFunc) {
			var otpStruct = bsnc.otp.util.struct();
			otpStruct.setPath("plc/gathering/stop");
			otpStruct.setParam("device.id", did);
			otpStruct.setParam("event.id", did);
			otpStruct.setParam("attribution.key", attKey);
			otpStruct.setSID(_authObj.getAuthInfo().sid);
		...
		plcMonitoringStart : function(did, content, contentType,cbSucessFunc, cbFailFunc, cbEventFunc) {
			var otpStruct = bsnc.otp.util.struct();
			otpStruct.setPath("plc/monitoring/start");
			otpStruct.setParam("device.id", did);
			otpStruct.setParam("event.id", did);
			otpStruct.setSID(_authObj.getAuthInfo().sid);
			otpStruct.setTID(_authObj.getAuthInfo().tid);
		...
		plcMonitoringStop : function(did, attKey, cbSucessFunc, cbFailFunc) {
			var otpStruct = bsnc.otp.util.struct();
			otpStruct.setPath("plc/monitoring/stop");
			otpStruct.setParam("device.id", did);
			otpStruct.setParam("event.id", did);
			otpStruct.setParam("attribution.key", attKey);
			otpStruct.setSID(_authObj.getAuthInfo().sid);
