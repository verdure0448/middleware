...
public abstract class AbstractTransactionAttributeHandler extends AbstractTransactionFunctionHandler implements IAttributeHandler{
	
	public AbstractTransactionAttributeHandler(String name){
		super(name);
	}
