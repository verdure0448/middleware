...
public class AdvancedSocketChannelConnection implements IConnection{
	...
	public AdvancedSocketChannelConnection(SelectionKey key, int ioReadBuffer, ConnectionHandleChain chc, ServicePool pool, Log logger){
	...
	private SequencePacketMerger packetMerger = new SequencePacketMerger();
	public int gatlingRead() throws IOException, AlreadyClosedException {
	...
	private class SequencePacketMerger implements Runnable{
		@Override
		public void run() {
			ByteBuffer packet;
			try{
				boolean mergerStart = true;
				do{
...
//			chc.currentThreadHandle(this, resultArrays);
	...
	@Override
	public synchronized void write(String packets) throws IOException, ClosedChannelException {
