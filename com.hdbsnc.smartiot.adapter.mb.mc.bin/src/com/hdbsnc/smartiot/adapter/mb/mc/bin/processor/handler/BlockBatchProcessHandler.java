...
/**
 * @author dbkim
 * Mc 프로토콜 3E프레임 블록일괄 읽기 및 쓰기를 실행 할 수 있는 핸들러
 */
public class BlockBatchProcessHandler extends AbstractTransactionTimeoutFunctionHandler{

	public BlockBatchProcessHandler(String name, long timeout, MitsubishiQSeriesApi api, List<ReadPlcVo> list, List<WritePlcVo> list2, Log _log) {
		super(name, timeout);
