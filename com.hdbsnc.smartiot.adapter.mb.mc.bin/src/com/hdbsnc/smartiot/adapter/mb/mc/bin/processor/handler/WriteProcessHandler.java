...
public class WriteProcessHandler extends AbstractTransactionTimeoutFunctionHandler {

	private MitsubishiQSeriesApi api;
	private Log log = null;
	private Log parentsLog = null;

	public WriteProcessHandler(String name, long timeout, MitsubishiQSeriesApi api, Log log) {
		super(name, timeout);
