 ...
 */
public class BatchPollingHealthcheckHandler extends AbstractTransactionTimeoutFunctionHandler {
	...
	public BatchPollingHealthcheckHandler(String name, long timeout, MitsubishiQSeriesApi api, List<RequestReadObj> readObjList,
